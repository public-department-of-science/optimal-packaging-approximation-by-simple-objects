...
namespace hs071_cs
{
    public class Data
    {
        ...
        public Data() : this(new int[1] { 1 }, new double[1] { 0.1 }, new double[1] { 0.1 }, new double[1] { 0.1 }, new double[1] { 0.1 }, null, 1)
        {
        }
        ...
        public Data(int[] amountOfSpheresInEachComplexObject, double[] x, double[] y, double[] z, double[] r, IContainer container, int objectsCount, ObjectType[] type = null, double[,] C = null) : this(container)
        {
